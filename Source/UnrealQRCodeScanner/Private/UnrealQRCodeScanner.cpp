...
#include "UnrealQRCodeScanner.h"

#define LOCTEXT_NAMESPACE "FUnrealQRCodeScannerModule"
...
void FUnrealQRCodeScannerModule::StartupModule()
{
...
void FUnrealQRCodeScannerModule::ShutdownModule()
{
#if defined(__aarch64__) || defined(_M_ARM64)
...
void FUnrealQRCodeScannerModule::CheckFileExists(const FString path, const FString fileName) {
...
void FUnrealQRCodeScannerModule::TraverseProjectDirectory() {
...
IMPLEMENT_MODULE(FUnrealQRCodeScannerModule, UnrealQRCodeScanner)